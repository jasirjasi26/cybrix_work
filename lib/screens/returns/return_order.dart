...
//       'Amount': am.toString(),
//       'ArabicName': "",
//       'Balance': double.parse(Customer.balance)+totalBill,
...
//       'TaxAmount': taxTotal.reduce((a, b) => a + b).toString(),
//       'TotalCESS': "0",
//       'TotalGST': "0",
//       'TotalVAT': taxTotal.reduce((a, b) => a + b).toString(),
//       'UpdatedBy': User.number,
//       'UpdatedTime': DateTime.now().toString(),
//       'VoucherDate': today,
//     };
...
//                                                                   "TotalStock"]
//                                                                       .toString();
//                                                                   // stock = map[index]["RateAndStock"][z]["Stock"]
