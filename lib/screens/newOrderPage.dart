...
class NewOrderPageState extends State<NewOrderPage> {
  ...
  void addtoInvoiceValues() {
    ...
    am = double.parse(am.toStringAsFixed(User.decimals));
    print(discountedBill.toStringAsFixed(4));
    ...
    Map<String, dynamic> values = {
      ...
      'TotalDiscount': d.toStringAsFixed(User.decimals),
      'CardReceived': "0",
      'CashReceived': "0",
  ...
  Future<void> addtoOrders() async {
    ...
    if (await DataConnectionChecker().hasConnection){
      ...
      APICacheDBModel cacheDBModel =
      new APICacheDBModel(key: values['OrderID'], syncData: body);
  ...
  saveToDb(Map<String, dynamic> finalData) async {
    ...
    print(finalData['OrderID']);
    ContactinfoModel contactinfoModel = ContactinfoModel(id: null,userId: finalData['OrderID'],createdAt: "Order");
    await Controller().addData(contactinfoModel).then((value){
      print(contactinfoModel.userId);
      if (value>0) {
