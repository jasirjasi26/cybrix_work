...
import 'package:cybrix/screens/offline_pages/offline_invoice_page.dart';
import 'package:cybrix/screens/offline_pages/offline_order_page.dart';
import 'package:cybrix/screens/offline_pages/offline_returns_page.dart';
        ...
        child: ListView(
          children: <Widget>[
            ...
            syncData
                ...
                trailing: Padding(
                  padding: const EdgeInsets.only(right: 70.0),
                  child: Text('Offline Invoice ',
                      style: TextStyle(color: Colors.black, fontSize: 18)),
                ),
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return OfflineInvoicePage();
                  }));
                })
                : Container(),
            syncData
                ...
                trailing: Padding(
                  padding: const EdgeInsets.only(right: 70.0),
                  child: Text('Offline Returns',
                      style: TextStyle(color: Colors.black, fontSize: 18)),
                ),
                onTap: () {
                  Navigator.push(context, MaterialPageRoute(builder: (context) {
                    return OfflineReturnsPage();
                  }));
                })
                : Container(),
            SizedBox(
